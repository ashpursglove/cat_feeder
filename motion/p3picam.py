...
#import StringIO - not for python 3
import io
import subprocess
import os
import time
...
filepath = "/home/pi/code/feeder/motion/motion_pictures"
...
#define function for getting boolean if motion is detected
...
def is_there_motion():
    ...
    while (True):
        ...
        if takePicture:
            ...
            return True #added return statements for use as module
        else:
            return False
